...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signo = (TextView) this.findViewById(R.id.Txt_Nombre_Signo);
        fechas = (TextView) this.findViewById(R.id.Txt_Fechas);
        img_view = (ImageView) this.findViewById(R.id.ImgVCentral);
        cambiarCentro(1);
    }
